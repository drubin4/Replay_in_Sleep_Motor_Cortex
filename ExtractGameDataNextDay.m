...
function [GamePosition GameSequences GameClock GameTrialOutcomes GameNewTrialTimes GameNewTrialEndTimes Xlim1 Xlim2] = ExtractGameDataNextDay(WhichSimonBlock)
%Pull the data from the Game file for plotting activity during the Simon game

   GameDataDir = '*DataDirectory*\Data\NextDayGameData';
