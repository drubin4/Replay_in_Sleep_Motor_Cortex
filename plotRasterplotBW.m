...
function S = plotRasterplotBW(StartTimeIndex_IC,EndTimeIndex_IC,fignum,DateNum_IC_TimeAxis,Thresholded_zSP);
...
S = image(DateNum_IC_TimeAxis(StartTimeIndex_IC:EndTimeIndex_IC),1:96,CO); 
% view(2)
% S.EdgeColor = 'none';
% S.LineStyle = 'none';
axis tight;
